...
func (h *navBarComp) Render() app.UI {
	return app.Nav().Class("navBar").Body(
		app.A().Href("/").Style("color", "black").Text("Movies"),
		app.A().Href("/tvshows").Style("color", "black").Text("TVShows"),
		app.A().Href("/search").Style("color", "black").Text("Search"),
	)
}
	...
	return app.Div().Body(
		...
		app.Main().Body(
			...
			app.Div().Class("wrapper").Body(
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/action").Text("Action")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/arnold").Text("Arnold")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/brucelee").Text("Bruce Lee")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/brucewillis").Text("Bruce Willis")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/buzz").Text("Buzz")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/cartoons").Text("Cartoons")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/charliebrown").Text("Charlie Brown")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/chucknorris").Text("Chuck Norris")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/comedy").Text("Comedy")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/drama").Text("Drama")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/documentary").Text("Documentary")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/fantasy").Text("Fantasy")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/ghostbusters").Text("Ghost Busters")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/godzilla").Text("Godzilla")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/harrisonford").Text("Harrison Ford")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/harrypotter").Text("Harry Potter")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/hellboy").Text("Hell Boy")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/indianajones").Text("Indiana Jones")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/jamesbond").Text("James Bond")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/johnwayne").Text("John Wayne")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/johnwick").Text("John Wick")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/jurassicpark").Text("Jurassic Park")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/kevincostner").Text("Kevin Costner")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/kingsmen").Text("Kings Men")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/lego").Text("Lego")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/meninblack").Text("Men In Black")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/minions").Text("Minions")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/misc").Text("Misc")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/nicolascage").Text("Nicolas Cage")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/oldies").Text("Oldies")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/pandas").Text("Pandas")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/pirates").Text("Pirates")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/riddick").Text("Riddick")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/scifi").Text("SciFi")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/stalone").Text("Stalone")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/startrek").Text("Star Trek")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/starwars").Text("Star Wars")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/superheros").Text("Super Heros")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/tinkerbell").Text("Tinker Bell")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/tomcruise").Text("Tom Cruise")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/transformers").Text("Trasnformers")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/tremors").Text("Tremors")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/therock").Text("The Rock")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/vandam").Text("Van Dam")),
				app.Div().Class("wrapItem").Body(app.A().Class("wrapA").Href("/xmen").Text("X Men")),
...
func (h *tvshows) Render() app.UI {
	return app.Div().Body(
		...
		app.Main().Body(
			...
			app.Div().Class("wrapper").Body(
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvaction").Text("Action")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvcomedy").Text("Comedy")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvfantasy").Text("Fantasy")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvmcu").Text("MCU")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvscience").Text("Science")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvscifi").Text("SciFi")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvstartrek").Text("Star Trek")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvstarwars").Text("Star Wars")),
				app.Div().Class("wrapItem").Body(app.A().Class("tvA").Href("/tvwesterns").Text("Westerns")),
		),
	),
	)
}
...
func (h *search) Render() app.UI {
	return app.Div().Body(
		...
		&navBarComp{},
		app.Main().Body(
			app.Div().Class("searchDiv").Body(
				app.H1().Class("test2").Text("Search"),
				app.Div().Class("searchBar").Body(
					app.Input().Type("text").Placeholder("Search..."),
					app.Button().Text("Search"),
				),
			),
		),
	)
